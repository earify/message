...
const messagesRef1 = firebase.database().ref("messages/chatting2");
...
function sendMessage() {
  ...
  // 메시지 길이가 180124을 초과하는지 확인
  if (nickname && message && message.length <= 180124) {
    // 줄바꿈 처리
  ...
  } else if (message.length > 180124) {
    alert("메시지는 180124글자 이하여야 합니다.");
  } else {
